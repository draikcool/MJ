...
//                refreshData1();
        ...
        intentFilter.addAction("com.example.hqb98.mj.activity.detaildate.two");
...
//    }
    ...
    private void initData1(){
        ...
        for (int i=0;i<DateFragmentOne.dateList.size();i++){
            if (DateFragmentOne.dateList.get(i).getDate_type().equals("生活经验")){
...
//        dateList.clear();
//        dateList.addAll(LitePal.where("date_type = '生活经验'").order("id desc").find(Date.class));
...
//        dates.addAll(LitePal.where("date_type = '生活经验'").order("id desc").find(Date.class));
//        if (dates.size()!=0){
//            dateList.clear();
